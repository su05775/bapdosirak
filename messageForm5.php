...
define('SITE_EMAIL', 'test@test.com');
    ...
    $message1 = '<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Data:</font></td>
        <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma">'.$_POST['data'].'</font></td>
      </tr>
           
      <tr>
        <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Hours:</font></td>
        <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma">'.$_POST['hours'].'</font></td>
      </tr>

      <tr>
        <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Amount:</font></td>
        <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma">'.$_POST['amount'].'</font></td>
      </tr>
